...
impl ClientConfigBuilder {
    ...
    /// # Examples
    /// ```no_run
    /// # async fn example() -> Result<(), selium_remote_client::ClientError> {
    /// let _client = selium_remote_client::ClientConfigBuilder::default()
...
impl Channel {
    ...
    ///
    /// # async fn example(channel: &selium_remote_client::Channel) -> Result<(), selium_remote_client::ClientError> {
